package com.dxc.openShopReport.core;

/**
 * 项目常量
 */
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.dxc.openShopReport";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    ...
    public static final String PCITURE_SERVER_URL = "http://137.135.112.26:8080/datas";
    public static final String REPORT_SERVER_URL = "http://137.135.112.26:8080/report";
}
